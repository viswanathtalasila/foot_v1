...
public class Controller implements Initializable {
    ...
    public void reset(ActionEvent event)throws IOException{
        //load the current image and reset viewport and imageview pane parameters (after a zoom was done)
        ...
        imageview.setViewport(viewportRect3);
        //since imageview fitwidth & height was changed in the zoom function, the reset function should take the new width and height from pane (parent of imageview)
